    ...
    <tr>
      <td colspan="2" valign="top"><table style="width: 100%; border: 0">
          <tr valign="top">
            ...
            <td align="right"><a href="#" onClick="doAboutUs(logInBankForm)">
            ...
            <td colspan="3"><table width="100%" border="0">
                <tr valign="top">
                  <td width="25%" valign="top"><table width="100%" border="0">
                      <tr>
                        <td colspan="2" class="lbl-cn"><bean:message key="label.indexgelp3"/></td>
                      </tr>
                      <tr>
                        <td align="right"><a href="#" onClick="doSignUp(logInBankForm)"><font class="link-b-08">
                          <bean:message key="label.signUp"/>
                          </font></a></td>
                        <td width="40%">&nbsp;</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td colspan="2" class="lbl-08"><a href="#" onClick="doMyNewPINForget(logInBankForm)"><font class="link-b-08">
                          <bean:message key="label.forgetPIN"/>
                          </font></a>
                          <bean:message key="label.|"/>
                          <a href="#" onClick="doHelp(logInBankForm)"><font class="link-b-08">
                          <bean:message key="label.help"/>
                          </font></a> </td>
                      </tr>
                      <tr>
                        <td colspan="2" class="lbl-cn"><bean:message key="label.indexhelp1"/></td>
                      </tr>
                    </table></td>
                  <td width="35%"><table width="100%" border="0">
                      ...
                      <tr>
                        <td>&nbsp;</td>
                        <td colspan="2" valign="top" class="lbl-cn">MyBank- Local</td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td width="15%">&nbsp;</td>
...
onmouseout="roll('SignIn', '/mybank/pages/images/loginup.gif')"> <img src="/mybank/pages/images/loginup.gif" name="SignIn" alt="Sign In" border="0"/></a></td>
                      ...
                      <tr>
                        <td>&nbsp;</td>
                        <td colspan="2"><font class="lbl-cn">
                          <bean:message key="label.use"/>
                          </font> <a href="https://www.bankasia.net"><font class="link-b-08">
                          <bean:message key="label.enhanced"/>
                          </font></a> <font class="usr-1">
                          <bean:message key="label.|"/>
                          </font> <a href="http://www.bankasia.net"><font class="link-b-08">
                          <bean:message key="label.standard"/>
                          </font></a> <font class="lbl-cn">
                          <bean:message key="label.security"/>
                          </font> </td>
                      </tr>
                    </table></td>
    ...
    <tr>
      <td valign="bottom"><table style="width: 100%; border: 0">
          <tr>
            ...
            <td width="80%" valign="bottom" class="lbl-08"><div align="center">
                <bean:message key="label.contactus1"/>
                <a href="#" onClick="doContactUs(logInBankForm)"><font class="link-b-08">
                <bean:message key="label.contactus"/>
                </font></a> </div></td>
            <td width="10%" rowspan="2" align="right" valign="bottom">&nbsp;</td>
          </tr>
          <tr>
            <td style="height: 10" valign="middle" class="lbl-08"><div align="center"> <a href="#" onClick="doAboutUs(logInBankForm)"><font class="link-b-08">
                <bean:message key="label.aboutUs"/>
                </font></a>
                <bean:message key="label.|"/>
                <a href="#" onClick="doBranchInfo(logInBankForm)"><font class="link-b-08">
                <bean:message key="label.about10"/>
                </font></a>
                <bean:message key="label.|"/>
                <a href="#" onClick="doATM(logInBankForm)"><font class="link-b-08">
                <bean:message key="label.eBanking"/>
                </font></a>
                <bean:message key="label.|"/>
                <a href="#" onClick="doSmsBanking(logInBankForm)"><font class="link-b-08">
                <bean:message key="label.smsBanking"/>
                </font></a>
                <bean:message key="label.|"/>
                <a href="#" onClick="doTeleBanking(logInBankForm)"><font class="link-b-08">
                <bean:message key="label.teleBanking"/>
                </font></a>
                <bean:message key="label.|"/>
                <a href="#" onClick="doPrivacyPolicy(logInBankForm)"><font class="link-b-08">
                <bean:message key="label.privacyPolicy"/>
                </font></a>
                <bean:message key="label.|"/>
                <a href="#" onClick="doTermsConditions(logInBankForm)"><font class="link-b-08">
                <bean:message key="label.termsConditions"/>
                </font></a> </div></td>
          </tr>
          <tr>
