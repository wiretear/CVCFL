...
<%@ page import="com.ibank.loan.report.bo.AccountSummaryReportBO"%>
<%@ page language="java" 
...
<script language="javascript" type="text/javascript">
	function   setBodyProperty() {
		...
		if(document.accountSummaryLoanReportForm.errorCode.value=="1"){
			var v1 ="";
		redirectMobiAppsTransfere(accountSummaryLoanReportForm,v1);
	...
	var ErrorMessage ="";
	if(v1==""){
		ErrorMessage = document.accountSummaryLoanReportForm.errorMessage.value;
		}else{
		ErrorMessage = v1;
		}
	...
	function doSearch(f,v1,v2){
		document.accountSummaryLoanReportForm.userCompanyCode.value = v1;
		document.accountSummaryLoanReportForm.userAccountNo.value = v2;
		f.action="/ibanking/balanceInfoLogIn.do";
		f.submit();
	}
	function doLogOut(f){
		if(confirm("Are you sure? If you confirm press OK button")){
			f.action="/ibankinguser/logOutibankLoanAccountSummary.do";
			f.submit();
		}
	}
		...
		if(confirm("Are you sure? If you confirm press OK button")){
			f.action="/ibankinguser/executeLoanAccountSummaryReport.do";
			f.submit();
		}
	}
	...
	function doExecutePDF(f){
		...
		function doClear(f){
		f.action="/ibankinguser/loanAccountSummaryReport.do";
		f.submit();
	}
...
<html:form action="/loanAccountSummaryReport" style="margin: 0;">
  ...
  <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
    <tr>
      ...
      <td style="height:20%; width:100%;" class="header-menu"><div style="text-align:left;line-height:20px;padding-top:10px;padding-left:20px"><img src="pages/menu/images/nbfilogo.png"></div>
        <div style="text-align:right;margin-top:-30px"><img src="pages/menu/images/Log-out.png" onClick="doLogOut(accountSummaryLoanReportForm)"></div></td>
    </tr>
    <tr>
      <td><div id='cssmenu'>
          <%
          ...
          <tr>
            <td><table style="width: 100%; align: center" border="0" height="22px">
               <tr>
                       ...
                       <font style="font-size:1.2em;color:#FFF;vertical-align:top">Loan Account Summary </font></td></tr>
              </table></td>
          </tr>
          <tr>
            <td><table style="width: 100%; align: center" border="0" height="22px">
               <tr>
                          <td align="right"><a href="#" onClick="goHomePage(accountSummaryLoanReportForm)">
                          ...
                          <td>
                             ...
                             <tr>
                              ...
                              <tr class="spaceUnder">
                                ...
                                <tr>
                                  <td align="right"><!--<input type="button" value="PDF"   onClick="doExecutePDF(accountSummaryLoanReportForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold" /> --></td>
                                  <td>&nbsp;</td>
                                   <td><input type="button" value="Submit"   onClick="doExecutePro(accountSummaryLoanReportForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold" />
            <input type="button" value="Clear"  onClick="doClear(accountSummaryLoanReportForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold"/></td>
                                </tr>
                                 <tr class="spaceUnder">
                                  <td align="right">&nbsp;</td>
                                  <td></td>
