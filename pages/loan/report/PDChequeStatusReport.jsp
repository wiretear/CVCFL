...
<%@ page import="com.ibank.loan.report.bo.PDChequeStatusReportBO"%>
<%@ page language="java" 
...
<script language="javascript" type="text/javascript">
	function   setBodyProperty() {
		...
		if(document.pDChequeStatusReportForm.errorCode.value=="1"){
			var v1 ="";
		redirectMobiAppsTransfere(pDChequeStatusReportForm,v1);
	...
	var ErrorMessage ="";
	if(v1==""){
		ErrorMessage = document.pDChequeStatusReportForm.errorMessage.value;
		}else{
		ErrorMessage = v1;
		}
	...
	function doSearch(f,v1,v2){
		document.pDChequeStatusReportForm.userCompanyCode.value = v1;
		document.pDChequeStatusReportForm.userAccountNo.value = v2;
		f.action="/ibanking/balanceInfoLogIn.do";
		f.submit();
	}
	function doLogOut(f){
		if(confirm("Are you sure? If you confirm press OK button")){
			f.action="/ibankinguser/logOutibankPDChequeStatus.do";
			f.submit();
		}
	}
		...
		if(confirm("Are you sure? If you confirm press OK button")){
			f.action="/ibankinguser/executePDChequeStatusReport.do";
			f.submit();
		}
	}
	...
	function doExecutePDF(f){
		...
		function doClear(f){
		f.action="/ibankinguser/pDChequeStatusReport.do";
		f.submit();
	}
...
<html:form action="/pDChequeStatusReport" style="margin: 0;">
  ...
  <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
    <tr>
      ...
      <td style="height:20%; width:100%;" class="header-menu"><div style="text-align:left;line-height:20px;padding-top:10px;padding-left:20px"><img src="pages/menu/images/nbfilogo.png"></div>
        <div style="text-align:right;margin-top:-30px"><img src="pages/menu/images/Log-out.png" onClick="doLogOut(pDChequeStatusReportForm)"></div></td>
    </tr>
    <tr>
      <td><div id='cssmenu'>
          <%
          ...
          <tr>
            <td><table style="width: 100%; align: center" border="0" height="22px">
               <tr>
                        ...
                        <font style="font-size:1.2em;color:#FFF;vertical-align:top">PD Cheque Status</font></td></tr>
              </table></td>
          </tr>
          <tr>
            <td><table style="width: 100%; align: center" border="0" height="22px">
               <tr>
                          <td align="right"><a href="#" onClick="goHomePage(pDChequeStatusReportForm)">
                          ...
                          <td>
                             ...
                             <tr>
                              ...
                              <tr class="spaceUnder">
                                ...
                                <tr>
                                  <td align="right"><!--<input type="button" value="PDF"   onClick="doExecutePDF(pDChequeStatusReportForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold" /> --></td>
                                  <td>&nbsp;</td>
                                   <td><input type="button" value="Submit"   onClick="doExecutePro(pDChequeStatusReportForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold" />
            <input type="button" value="Clear"  onClick="doClear(pDChequeStatusReportForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold"/></td>
                                </tr>
                                 <tr class="spaceUnder">
                                  <td align="right">&nbsp;</td>
                                  <td></td>
