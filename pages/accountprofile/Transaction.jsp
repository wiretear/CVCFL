...
<%@ page import="com.ibank.accountprofile.bo.TransactionBO"%>
<%@ page language="java" 
		 import ="com.ibank.accountprofile.bo.*,java.util.ArrayList"
         session      = "true"
		 autoFlush    = "true"
		 isThreadSafe = "true" 
		 isErrorPage  = "false"
...
<script language="javascript" type="text/javascript">
	function   setBodyProperty() {
		...
		if(document.transactionForm.errorCode.value=="1"){
			var v1 ="";
		redirectMobiAppsTransfere(transactionForm,v1);
	...
	var ErrorMessage ="";
	if(v1==""){
		ErrorMessage = document.transactionForm.errorMessage.value;
		}else{
		ErrorMessage = v1;
		}
	...
	function doSearch(f,v1,v2){
		document.transactionForm.userCompanyCode.value = v1;
		document.transactionForm.userAccountNo.value = v2;
	...
	function doLogOut(f){
		...
		if(confirm("Are you sure? If you confirm press OK button")){
			f.action="/ibankinguser/searchTransactionInfoEnquiry.do";
			f.submit();
		}
	}
	...
	function doExecutePDF(f){
			...
			f.action="/ibankinguser/ReportTransactionStatement.do";
			f.submit();
		}
		
		function doClear(f){
		f.action="/ibankinguser/transactionInfoEnquiry.do";
		f.submit();
	}
...
<html:form action="/transactionInfoEnquiry" style="margin: 0;">
  ...
  <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
    <tr>
      ...
      <td style="height:20%; width:100%;" class="header-menu"><div style="text-align:left;line-height:20px;padding-top:10px;padding-left:20px"><img src="pages/menu/images/nbfilogo.png"></div>
        <div style="text-align:right;margin-top:-30px"><img src="pages/menu/images/Log-out.png" onClick="doLogOut(transactionForm)"></div></td>
    </tr>
    <tr>
      <td><div id='cssmenu'>
          <%
  ...
  %>
          ...
          <tr>
            <td><table style="width: 100%; align: center" border="0" height="22px">
               <tr>
                        ...
                        &nbsp;<font style="font-size:1.2em;color:#FFF;vertical-align:top">Accounts Statement</font></td></tr>
              </table></td>
          </tr>
          <tr>
            <td><table style="width: 100%; align: center" border="0" height="22px">
               <tr>
                          <td align="right"><a href="#" onClick="goHomePage(transactionForm)">
                             ...
                             <tr>
                                ...
                                <tr class="spaceUnder">
                                 <td align="right">From Date</td>
                                  <td>&nbsp;</td>
                                   <td><html:text property="dateFrom" styleClass="txt-n" styleId="datepicker" style="width:210px; text-align: left;"/></td>
                                </tr>
                                <tr class="spaceUnder">
                                 <td align="right">To Date</td>
                                  <td>&nbsp;</td>
                                   <td><html:text property="dateTo" styleClass="txt-n" styleId="datepicker1" style="width:210px; text-align: left;"/></td>
                                </tr>
                                <tr>
                                 <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                ...
                                <tr>
                                  <td align="right"><!--<input type="button" value="PDF"   onClick="doExecutePDF(transactionForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold" /> --></td>
                                  <td>&nbsp;</td>
                                   <td><input type="button" value="Submit"   onClick="doExecutePro(transactionForm)" style="width:70px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold" />
                                   <input type="button" value="PDF"   onClick="doExecutePDF(transactionForm)" style="width:60px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold" />
            <input type="button" value="Clear"  onClick="doClear(transactionForm)" style="width:60px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold"/></td>
                                </tr>
                                 <tr class="spaceUnder">
                                  <td align="right">&nbsp;</td>
                                  <td></td>
                ...
                <table style="width: 100%; align: center; border: 0" cellpadding="3" cellspacing="1">
                  ...
                  <tr>
                    ...
                    <table style="width: 100%" border="1" align="center" cellpadding="3" cellspacing="1">
                        <tr bgcolor="#99CCCC">
                          <th width="4%" style="height: 35; text-align:center"  valign="middle" class="lbl-b-08"> <bean:message key="label.srNo"/></th>
                          <th width="8%" style="text-align:center" valign="middle" class="lbl-b-08"><bean:message key="label.date"/></th>
                          <th width="16%" style="text-align:center" valign="middle" class="lbl-b-08">Trans Code Doc No</th>
                          <th width="36%" align="center" valign="middle" class="lbl-b-08"><bean:message key="label.particulars"/></th>
                          <th width="12%" style="text-align:right"  class="lbl-b-08"><bean:message key="label.debitAmount"/></th>
                          <th width="12%" style="text-align:right"  class="lbl-b-08"><bean:message key="label.creditAmount"/></th>
                          <th width="12%" style="text-align:right" class="lbl-b-08"><bean:message key="label.balanceAmount"/></th>
                        </tr>
             
             
              <%
				if(session.getAttribute("oTransactionStatementListBO")!=null){
				TransactionBO mainBO=(TransactionBO)session.getAttribute("oTransactionStatementListBO");
				...
				TransactionBO bo=(TransactionBO)aStatementList.get(i);
				String sSerialNo = bo.getSerialNo();				
				String sDateInfo = bo.getDateInfo();
				String sChqNumber = bo.getChqNumber();
				String sParticulars = bo.getParticulars();
				String sDebitAmount = bo.getDebitAmount();
				String sCreditAmount = bo.getCreditAmount();
				String sBalanceAmount = bo.getBalanceAmount();
			  %>
                        <tr bgcolor="#99CCFF">
                          <td valign="top" class="lbl-08" align="center"><%=sSerialNo%></td>
                           <td valign="top" class="lbl-08" align="center"><%=sDateInfo%></td>
                          <td valign="top" class="lbl-08" align="center"><%=sChqNumber%></td>                         
                          <td valign="top" class="lbl-08" align="left"><%=sParticulars%></td>
    ...
    <tr >
      <td valign="bottom"><table style="width: 100%; align: center; border: 0" class="footer">
          <tr>
