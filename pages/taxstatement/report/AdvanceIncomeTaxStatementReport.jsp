...
<%@ page import="com.ibank.taxstatement.report.bo.AdvanceIncomeTaxReportBO"%>
<%@ page language="java" 
		 import ="com.ibank.taxstatement.report.bo.*,java.util.ArrayList"
         session      = "true"
		 autoFlush    = "true"
		 isThreadSafe = "true" 
		 isErrorPage  = "false"
...
<script language="javascript" type="text/javascript">
	function   setBodyProperty() {
		...
		if(document.advanceIncomeTaxReportReportForm.errorCode.value=="1"){
			var v1 ="";
		redirectMobiAppsTransfere(advanceIncomeTaxReportReportForm,v1);
	...
	var ErrorMessage ="";
	if(v1==""){
		ErrorMessage = document.advanceIncomeTaxReportReportForm.errorMessage.value;
		}else{
		ErrorMessage = v1;
		}
	...
	function doSearch(f,v1,v2){
		document.advanceIncomeTaxReportReportForm.userCompanyCode.value = v1;
		document.advanceIncomeTaxReportReportForm.userAccountNo.value = v2;
	...
	function goHomePage(f){
		...
		if(confirm("Are you sure? If you confirm press OK button")){
			f.action="/ibankinguser/advanceIncomeTaxStatementPDF.do";
			f.submit();
		}
	}
		...
		function doClear(f){
		f.action="/ibankinguser/advanceIncomeTaxStatementReport.do";
		f.submit();
	}
...
<html:form action="/advanceIncomeTaxStatementReport" style="margin: 0;">
  ...
  <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
    <tr>
      ...
      <td style="height:20%; width:100%;" class="header-menu"><div style="text-align:left;line-height:20px;padding-top:10px;padding-left:20px"><img src="pages/menu/images/nbfilogo.png"></div>
        <div style="text-align:right;margin-top:-30px"><img src="pages/menu/images/Log-out.png" onClick="doLogOut(advanceIncomeTaxReportReportForm)"></div></td>
    </tr>
    <tr>
      <td><div id='cssmenu'>
          <%
          ...
          <tr>
            <td><table style="width: 100%; align: center" border="0" height="22px">
               <tr>
                        ...
                        &nbsp;<font style="font-size:1.2em;color:#FFF;vertical-align:top">AIT-Deposit Statement</font></td></tr>
              </table></td>
          </tr>
          <tr>
            <td><table style="width: 100%; align: center" border="0" height="22px">
               <tr>
                          <td align="right"><a href="#" onClick="goHomePage(advanceIncomeTaxReportReportForm)">
                        ...
                        <tr>
                          <td>
                             ...
                             <tr>
                                ...
                                <tr>
                                  <td align="right"><!--<input type="button" value="PDF"   onClick="doExecutePDF(advanceIncomeTaxReportReportForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold" /> --></td>
                                  <td>&nbsp;</td>
                                   <td><input type="button" value="Submit"   onClick="doExecutePro(advanceIncomeTaxReportReportForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold" />
            <input type="button" value="Clear"  onClick="doClear(advanceIncomeTaxReportReportForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold"/></td>
                                </tr>
                                 <tr class="spaceUnder">
                                  <td align="right">&nbsp;</td>
                                  <td></td>
