...
<%@ page import="com.ibank.taxstatement.report.bo.TaxStateMentReportBO"%>
<%@ page language="java" 
...
<script language="javascript" type="text/javascript">
	function   setBodyProperty() {
		...
		if(document.taxStatementReportForm.errorCode.value=="1"){
			var v1 ="";
		redirectMobiAppsTransfere(taxStatementReportForm,v1);
	...
	var ErrorMessage ="";
	if(v1==""){
		ErrorMessage = document.taxStatementReportForm.errorMessage.value;
		}else{
		ErrorMessage = v1;
		}
	...
	function doSearch(f,v1,v2){
		document.taxStatementReportForm.userCompanyCode.value = v1;
		document.taxStatementReportForm.userAccountNo.value = v2;
	...
	function doLogOut(f){
		...
		if(confirm("Are you sure? If you confirm press OK button")){
			f.action="/ibankinguser/taxStatementReportPDF.do";
			f.submit();
		}
	}
	...
	function doExecutePDF(f){
		...
		function doClear(f){
		f.action="/ibankinguser/taxStatementReport.do";
		f.submit();
	}
...
<html:form action="/taxStatementReport" style="margin: 0;">
  ...
  <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
    <tr>
      ...
      <td style="height:20%; width:100%;" class="header-menu"><div style="text-align:left;line-height:20px;padding-top:10px;padding-left:20px"><img src="pages/menu/images/nbfilogo.png"></div>
        <div style="text-align:right;margin-top:-30px"><img src="pages/menu/images/Log-out.png" onClick="doLogOut(taxStatementReportForm)"></div></td>
    </tr>
    <tr>
      <td><div id='cssmenu'>
          <%
          ...
          <tr>
            <td><table style="width: 100%; align: center" border="0" height="22px">
               <tr>
                        ...
                        &nbsp;<font style="font-size:1.2em;color:#FFF;vertical-align:top">Loan Tax Statement</font></td></tr>
              </table></td>
          </tr>
          <tr>
            <td><table style="width: 100%; align: center" border="0" height="22px">
               <tr>
                          <td align="right"><a href="#" onClick="goHomePage(taxStatementReportForm)">
                        ...
                        <tr>
                          <td>
                             ...
                             <tr>
                                ...
                                <tr>
                                  <td align="right"><!--<input type="button" value="PDF"   onClick="doExecutePDF(taxStatementReportForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold" /> --></td>
                                  <td>&nbsp;</td>
                                   <td><input type="button" value="Submit"   onClick="doExecutePro(taxStatementReportForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold" />
            <input type="button" value="Clear"  onClick="doClear(taxStatementReportForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold"/></td>
                                </tr>
                                 <tr class="spaceUnder">
                                  <td align="right">&nbsp;</td>
                                  <td></td>
