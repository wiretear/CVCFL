	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" />' : sSearchStr+' <input type="text" placeholder="Search" />';
...
function toggleRowOnEdit(elem) {
	...
	if(selectedRow.className === 'odd'){		
		selectedRow.className = 'editOddBG';	
	} if(selectedRow.className === 'even'){		
		selectedRow.className = 'editEvenBG';	
	} else if(selectedRow.className === 'editOddBG'){		
		selectedRow.className = 'editOddBG';	
	} else if(selectedRow.className === 'editEvenBG'){		
		selectedRow.className = 'editEvenBG';	
	}
}
...
function setDefaultRowBackColor() {	
	...
	for(var i=0; i<tableRowCount; i++) {		
		if(i % 2 == 0) {
			document.getElementById('tbod').getElementsByTagName('tr')[i].className = 'odd';
		} else {
			document.getElementById('tbod').getElementsByTagName('tr')[i].className = 'even';
		}		
	}	
}
...
function deleteRowBackground(elem) {
	...
	var selectedRow = elem.parentElement.parentElement;
	if(selectedRow.className === 'odd'){		
		selectedRow.className = 'deleteOddBG';	
	} if(selectedRow.className === 'even'){		
		selectedRow.className = 'deleteEvenBG';	
	} else if(selectedRow.className === 'deleteOddBG'){		
		selectedRow.className = 'deleteOddBG';	
	} else if(selectedRow.className === 'deleteEvenBG'){		
		selectedRow.className = 'deleteEvenBG';	
	}
}
