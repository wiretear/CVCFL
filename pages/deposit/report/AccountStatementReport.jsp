...
<%@ page import="com.ibank.deposit.report.bo.AccountStatementReportBO"%>
<%@ page language="java" 
...
<script language="javascript" type="text/javascript">
	function   setBodyProperty() {
		...
		if(document.accountStatementReportForm.errorCode.value=="1"){
			var v1 ="";
		redirectMobiAppsTransfere(accountStatementReportForm,v1);
	...
	var ErrorMessage ="";
	if(v1==""){
		ErrorMessage = document.accountStatementReportForm.errorMessage.value;
		}else{
		ErrorMessage = v1;
		}
	...
	function doSearch(f,v1,v2){
		document.accountStatementReportForm.userCompanyCode.value = v1;
		document.accountStatementReportForm.userAccountNo.value = v2;
...
<html:form action="/depositAccountStatementReport" style="margin: 0;">
  ...
  <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
    <tr>
      ...
      <td style="height:20%; width:100%;" class="header-menu"><div style="text-align:left;line-height:20px;padding-top:10px;padding-left:20px"><img src="pages/menu/images/nbfilogo.png"></div>
        <div style="text-align:right;margin-top:-30px"><img src="pages/menu/images/Log-out.png" onClick="doLogOut(accountStatementReportForm)"></div></td>
    </tr>
    <tr>
      <td><div id='cssmenu'>
          <%
          ...
          <tr>
            <td><table style="width: 100%; align: center" border="0" height="22px">
               <tr>
                        ...
                        <img src="pages/menu/images/balance.png" height="22px" width="82px">&nbsp;<font style="font-size:1.2em;color:#FFF;vertical-align:top">Account Statement Report Deposit</font></td></tr>
              </table></td>
          </tr>
          <tr>
            <td><table style="width: 100%; align: center" border="0" height="22px">
               <tr>
                          <td align="right"><a href="#" onClick="goHomePage(accountStatementReportForm)">
                          ...
                          <td>
                             ...
                             <tr>
                                 ...
                                 <td align="right">As On Date</td>
                                  <td>&nbsp;</td>
                                   <td><html:text property="dateTo" styleClass="txt-n" styleId="datepicker" style="width:210px; text-align: left;"/></td>
                              ...
                              <tr class="spaceUnder">
                                  ...
                                  <td align="left"><html:select property="accountNo" style="width:210px">
                                                ...
                                                <html:options property="accountInfoNameList" styleClass="txt-n" labelProperty="accountInfoList"/>
                                              </html:select>
             				 </td>
                                </tr>
                                ...
                                <tr>
                                  <td align="right"><!--<input type="button" value="PDF"   onClick="doExecutePDF(accountStatementReportForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold" /> --></td>
                                  <td>&nbsp;</td>
                                   <td><input type="button" value="Submit"   onClick="doExecutePro(accountStatementReportForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold" />
            <input type="button" value="Clear"  onClick="doClear(accountStatementReportForm)" style="width:100px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold"/></td>
                                </tr>
                                 <tr class="spaceUnder">
                                  <td align="right">&nbsp;</td>
                                  <td></td>
            ...
            <td colspan="4"><div id="tableContainer" class="tableContainer" style="height:100%;overflow:auto;border-color:#FFF">
              ...
              <%
				if(session.getAttribute("oTransactionStatementListBO")!=null){
					AccountStatementReportBO mainBO=(AccountStatementReportBO)session.getAttribute("oTransactionStatementListBO");
