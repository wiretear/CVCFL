          ...
          <tr>
            <td><table style="width: 100%; align: center" border="0">
                <tr>
                  ...
                  <td width="29%" valign="top"><div class="panel-border">
                  ...
                  <td width="30%" valign="top"><table style="width: 100%; align: center" border="0" height="100%">
                      <tr height="49%">
                        <td><div class="panel-border">
                            <table style="width: 100%; align: center" border="0" height="100%">
                              <tr>
                                ...
                                <td><div id="tableContainer" class="tableContainer" style="height:120px;">
                                    <table width="100%" style="font-size:12px;">
                                      ...
                                      <%
										...
										%>
                                      <tr>
                                        <td  align="left" class="text_content_left_act_dtl"><%=sUserAccountNo%></td>
                  ...
                  <td width="29%" valign="top"><div class="panel-border">
                      <table style="width: 100%; align: center" border="0" height="100%">
                        ...
                        <tr>
                          <td><div id="tableContainer" class="tableContainer" style="height:300px;">
                              <p class="text_content_left" style="font-size:12px;margin-bottom:132px">
                              	&nbsp;&nbsp;&nbsp;<img src="pages/menu/images/bullet_2.gif" style="vertical-align:middle">&nbsp;<a href="#" onClick="doAccountStatement(logInForm)"><font class="text_content_links">Account Statement</font></a><br/>
                                &nbsp;&nbsp;&nbsp;<img src="pages/menu/images/bullet_2.gif" style="vertical-align:middle">&nbsp;<a href="#" onClick="doFundTransfer(logInForm)"><font class="text_content_links">Fund Transfer</font></a><br/>
                                &nbsp;&nbsp;&nbsp;<img src="pages/menu/images/bullet_2.gif" style="vertical-align:middle">&nbsp;<a href="#" onClick="doChequeLeafStop(logInForm)"><font class="text_content_links">Cheque Leaf Stop</font></a><br/>
                                &nbsp;&nbsp;&nbsp;<img src="pages/menu/images/bullet_2.gif" style="vertical-align:middle">&nbsp;<a href="#" onClick="doChequeStatus(logInForm)"><font class="text_content_links">Status of a Cheque Book</font></a><br/>
                                &nbsp;&nbsp;&nbsp;<img src="pages/menu/images/bullet_2.gif" style="vertical-align:middle">&nbsp;<a href="#" onClick="doTalkTimeRecharge(logInForm)"><font class="text_content_links">Talk Time Recharge</font></a> </p>
                              <p>&nbsp;</p>
                            </div></td>
                        </tr>
                      </table>
