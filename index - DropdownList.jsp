  ...
  function removeSpaces(String){
	...
	*/
	...
	function ComName(){
		...
		var label = document.getElementById('company')[document.getElementById('company').selectedIndex].innerHTML;
		var CompanyName = label.substring(4);
		 CompanyCode = label.substring(0,3)	

		$("#CName").text(CompanyName);		
			 
		alert(CompanyCode);	 
	
		document.getElementById('image').src = "pages/images/"+CompanyCode+".png";
      ...
      <td colspan="2" valign="top"><table  style="width: 100%;height:100%; border: 0">
          <tr>
            <td colspan="2"><div style="background-image:url(pages/images/index.png); background-repeat:repeat-x;height:100px;width:100%">
                ...
                <span style="padding-left:60px;font-size:3.5em;font-family:Monotype Corsiva;color:#DECBFC;text-align:center" id="CName"></span></div>
...
-->
                    <table width="70%" height="100%" style="background-image:url(pages/images/Blue-lines-background.jpg); background-size:100%; height:100%; border:1px; solid #66CCFF" align="center"  >
                      <tr>

                		 <td colspan="3" valign="top"><img src="pages/images/Login3.jpg" width="100%" height="70px" /></td>
                        ...
                        <tr>
                          <td colspan="3"><table style="width: 100%; align: center" border="0">         
                                ...
                                <td class="msg-10" align="center" valign="top">&nbsp;<strong>
                                  <%out.print(session.getAttribute("oLogInPmsMessageBO"));%>
                                  </strong></td>                        
                            </table></td>
                        </tr>          
                        
              <tr>
               <td width="30%" class="lbl-n" align="right" >Company Name </td>
               <td width="2%" >&nbsp;</td>
               <td width="68%" id="inter"><html:select property="companyID" styleId="company" styleClass="txt-n" style="width:210px" onchange="ComName()">                                   
                 	    <html:option value="" styleClass="txt-n">
                       <bean:message key="label.pleaseSelectOne"/>
                       </html:option>
                       <html:options property="companyTypeList" styleClass="txt-n" labelProperty="companyNameList"/>
                       </html:select> 
                          </td>
                        </tr>                                      
                         ...
                         <tr>
                          <td width="30%" class="lbl-n" align="right" ><img src="pages/images/user.png" width="34" height="20" style="vertical-align:middle"/>User ID</td>
                           <td width="2%" >&nbsp;</td>
                          <td width="68%" id="inter"  onKeyPress="goPassword(event);"><html:text property="userID"  tabindex="1" style="txt-n; width:210px" 
      ...
      <td valign="bottom"><table width="100%"   class="footer-menu" style="width: 100%; border: 0;" >
                <tr style="background-image:url(/pages/images/index.png);background-repeat:repeat-x;height:100%;width:100%;">
                  ...
                  <td width="84%" align="center" valign="middle" class="link-b-081"><!--<bean:message key="label.contactus1"/>
                    <a href="#" onClick="doContactUs(logInPmsForm)"><font class="link-b-082">
                    <bean:message key="label.contactus"/>
                    </font></a>-->                   
                    <a href="#" onClick="doCopyright(logInPmsForm)"><font class="fot-01">
