...
<html:form action="/ibankingLogIn" style="margin: 0">
  <div id="page-background"> <img src="pages/images/BG.jpg" width="100%" height="99%" alt="Bank Asia Limited"> </div>
  <!--------Header START--------->
  
  <div style="height:100%; width:100%; margin-left:auto;margin-right:auto;margin-top:auto;margin-bottom:auto">
...
<div style="height:40%; width:40%;padding-right:20px;float:right; vertical-align:top">
   <div  id="myModal" role="dialog">
    ...
    <div style="float:left;width:50%;height:45%">
      <div style="margin-left:180px; margin-top:10px;color:#FFF"> 
	  <%= new SimpleDateFormat("EEEE MMMM dd, yyyy").format(new Date( new Date().getTime() - TimeZone.getDefault().getRawOffset() - TimeZone.getDefault().getDSTSavings()))%> </br>		
        ...
        <span style="margin-left:30%"><img src="pages/images/9.png" style="width:60px;height:20px" ></span> 
        </div>
        
      <div class="rcorners2" style="float:left; margin-left:30px;margin-top:9%;height:100%;width:40%;background-color:#FFF">
