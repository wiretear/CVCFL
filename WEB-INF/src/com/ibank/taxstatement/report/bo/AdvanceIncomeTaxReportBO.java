package com.ibank.taxstatement.report.bo;
...
public class AdvanceIncomeTaxReportBO implements Serializable {
	 ...
	 * @return
	 */
	public AdvanceIncomeTaxReportBO() {
	}
	/**
	 * @return
	 */
	...
	public static ArrayList getMyBankMenu(String sUserID,String sSessionID){
		AdvanceIncomeTaxReportDAO oTransactionDAO = new AdvanceIncomeTaxReportDAO();
