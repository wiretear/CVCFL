...
public class PDChequeStatusReportBO {
	...
	public static ArrayList getMyBankMenu(String sUserID,String sSessionID){
		PDChequeStatusReportDAO oTransactionDAO = new PDChequeStatusReportDAO();
		ArrayList aList = oTransactionDAO.getibnkMenu(sUserID, sSessionID);
		return aList;
	}
}
