...
import com.ibank.deposit.report.dao.AccountSummaryReportDAO;
import com.ibank.deposit.report.formbean.AccountSummaryReportForm;
...
public class AccountSummaryReportAction  extends Action {
	...
	public ActionForward execute(ActionMapping mapping,
		...
		String sClientActionPath = "/ibankinguser/depositAccountSummaryReport.do";
		...
		if (sActionPath.equals("/depositAccountSummaryReport")) {
		...
		else if (sActionPath.equals("/logOutibankDepositAccountSummary")) {
			clearSession(session);
			session.setAttribute("oAccountSummaryReportBO", null);
			session.setAttribute("oAccountSummaryReportMessageBO", null);
			session.setAttribute("TransactionDateFrom", null);
		...
		else if (sActionPath.equals("/executeDepositAccountSummaryReport")) {
			  session.setAttribute("oUserActivityHistoryReportMessageBO"," ");
				System.out.print("I am in");
				oAccountSummaryReportBO = oAccountSummaryReportDAO.getApiDetails("ibnk", request.getRemoteAddr(), gsUserID, gsSessionID, "001", "I", "07");
				if (oAccountSummaryReportBO.getErrorCode().equals("0")) {	
			...
			/*	oAccountSummaryReportBO = oAccountSummaryReportDAO.getExecuteStatementProAPI(oAccountSummaryReportForm.getAccountNo(),
