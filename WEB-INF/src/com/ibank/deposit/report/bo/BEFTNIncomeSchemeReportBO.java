package com.ibank.deposit.report.bo;
...
public class BEFTNIncomeSchemeReportBO implements Serializable {
	...
	private String sUrl="";
	private String beftnProduct="";
	private String beftnName="";
	public String getBeftnProduct() {
		return beftnProduct;
	}
	public void setBeftnProduct(String beftnProduct) {
		this.beftnProduct = beftnProduct;
	}
	public String getBeftnName() {
		return beftnName;
	}
	public void setBeftnName(String beftnName) {
		this.beftnName = beftnName;
	}



	private String sTargetUrlToken="";
	public String getTargetUrlToken() {
		return sTargetUrlToken;
	}
	public void setTargetUrlToken(String targetUrlToken) {
		this.sTargetUrlToken = targetUrlToken;
	}
	public String getTargetUrlApi() {
		return sTargetUrlApi;
	}
	public void setTargetUrlApi(String targetUrlApi) {
		this.sTargetUrlApi = targetUrlApi;
	}
	...
	public void setApiPassword(String apiPassword) {
		this.sApiPassword = apiPassword;
	}


	private String sTargetUrlApi="";
	 ...
	 * @return
	 */
	public BEFTNIncomeSchemeReportBO() {
	}
	/**
	 * @return
	 */
	...
	public static ArrayList getMyBankMenu(String sUserID,String sSessionID){
		BEFTNIncomeSchemeReportDAO oTransactionDAO = new BEFTNIncomeSchemeReportDAO();
