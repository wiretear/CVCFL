...
public class AccountStatementReportBO implements Serializable {
	 ...
	 * @return
	 */
	public AccountStatementReportBO() {
	}
	/**
	 * @return
	 */
	...
	public static ArrayList getMyBankMenu(String sUserID,String sSessionID){
		AccountStatementReportDAO oTransactionDAO = new AccountStatementReportDAO();
