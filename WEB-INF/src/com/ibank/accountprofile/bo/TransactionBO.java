...
package com.ibank.accountprofile.bo;
...
public class TransactionBO  implements Serializable {
	...
	private String sMaturitySanctionLevel="";
	private String sSanctionDate="";
	private String sSanMaturityDate="";
	private String sDisburseRenewLevel="";
	private String sDisburseAmount="";
	private String sLastReshDateLevel="";
	private String sLastReschDate="";
	private String sReshCountLevel ="";
	private String sReshCount="";
	private String sPresentAdd="";
	private String sAccountStatus = "";
	private String sOpenDate="";
	private String sCustomerCode = "";
	private String sIntRate = "";
	...
	public void setAccountType(String accountType) {
		this.sAccountType = accountType;
	}
	public String getIntRate() {
		return sIntRate;
	}
	public void setIntRate(String intRate) {
		this.sIntRate = intRate;
	}
	public String getCustomerCode() {
		return sCustomerCode;
	}
	public void setCustomerCode(String customerCode) {
		this.sCustomerCode = customerCode;
	}
	public String getOpenDate() {
		return sOpenDate;
	}
	public void setOpenDate(String openDate) {
		this.sOpenDate = openDate;
	}
	public String getBranchName() {
		return sBranchName;
	}
	public void setBranchName(String branchName) {
		this.sBranchName = branchName;
	}
	...
	public String getMaturitySanctionLevel() {
		return sMaturitySanctionLevel;
	}
	public void setMaturitySanctionLevel(String maturitySanctionLevel) {
		this.sMaturitySanctionLevel = maturitySanctionLevel;
	}
	public String getSanctionDate() {
		return sSanctionDate;
	}
	public void setsanctionDate(String sanctionDate) {
		this.sSanctionDate = sanctionDate;
	}
	public String getSanMaturityDate() {
		return sSanMaturityDate;
	}
	public void setSanMaturityDate(String sanMaturityDate) {
		this.sSanMaturityDate = sanMaturityDate;
	}
	public String getDisburseRenewLevel() {
		return sDisburseRenewLevel;
	}
	public void setDisburseRenewLevel(String disburseRenewLevel) {
		this.sDisburseRenewLevel = disburseRenewLevel;
	}
	public String getDisburseAmount() {
		return sDisburseAmount;
	}
	public void setDisburseAmount(String disburseAmount) {
		this.sDisburseAmount = disburseAmount;
	}
	public String getLastReshDateLevel() {
		return sLastReshDateLevel;
	}
	public void setLastReshDateLevel(String lastReshDateLevel) {
		this.sLastReshDateLevel = lastReshDateLevel;
	}
	public String getLastReschDate() {
		return sLastReschDate;
	}
	public void setLastReschDate(String lastReschDate) {
		this.sLastReschDate = lastReschDate;
	}
	public String getReshCountLevel() {
		return sReshCountLevel;
	}
	public void setReshCountLevel(String reshCountLevel) {
		this.sReshCountLevel = reshCountLevel;
	}
	public String getReshCount() {
		return sReshCount;
	}
	public void setReshCount(String reshCount) {
		this.sReshCount = reshCount;
	}
	public String getPresentAdd() {
		return sPresentAdd;
	}
	public void setPresentAdd(String presentAdd) {
		this.sPresentAdd = presentAdd;
	}
	public String getAccountStatus() {
		return sAccountStatus;
	}
	public void setAccountStatus(String accountStatus) {
		this.sAccountStatus = accountStatus;
	}
