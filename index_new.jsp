...
<html:form action="/ibankingLogIn" style="margin: 0">
  <div id="page-background"> <img src="pages/assets/img/img-body-new.jpg" width="100%" height="99%" alt="Bank Asia Limited"> </div>
  <!--------Header START--------->
        ...
        <div class="modal-body" style="padding:20px 50px; background-color:#FFF">
          <form role="form">
            ...
            <img src="pages/images/pass-2.png" style="height:23px" id="input_img" />
              ...
              <button type="submit" class="btn btn-success btn-block"  onclick="doSignIn()"> <span class="glyphicon"></span> <img src="pages/images/pass-3.png" id="input_img" /> Login</button>
          </form>
        </div>
