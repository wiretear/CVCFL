...
<%@ page import="com.ibank.login.bo.IBankingLogInBO"%>
...
<script language="javascript" type="text/javascript">
	...
	function doSignIn(){
		...
		var f = document.ibankingLogInForm;
		 f.action="/ibanking/ibankingLogInSubmit.do";
	     f.submit();
...
.rcorners2 {
    ...
    <html:form action="/ibankingLogIn" style="margin: 0">
      ...
      <div class="top-content">
        ...
        <span style="margin-left:20%"><img src="pages/images/9.png" style="width:60px;height:20px" ></span>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col-sm-4  wow fadeInUp">
                        <div class="howto-bg rcorners2">
                        <span><img src="pages/images/1.png" style="height:25px;margin-left:10px;margin-top:10px"> </span></br>
                           <h3>Security Guideline</h3>
                             <hr/>
                           <p class="fa fa-caret-square-o-right font"> Never disclose your password or any security information to anyone.</p>
                           <p class="fa fa-caret-square-o-right font">  TalktimDon't use the "save password option" on your computer.</p>  
                           <p class="fa fa-caret-square-o-right font"> Use virtual keyboard for secure Login.</p>
                           <p class="fa fa-caret-square-o-right font"> Ensure the address bar URL with https.</p>
                           <p class="fa fa-caret-square-o-right font"> Change your password periodically.</p>
                        </div>
                     </div>
                    
                     <div class="col-sm-4 wow fadeInUp">
                        <div class="howto-bg rcorners2">
                   <span><img src="pages/images/2.png" style="height:25px;margin-left:10px;margin-top:10px"> </span></br>
                           <h3>New Features</h3>
                           <hr/>
                           <p class="fa fa-caret-square-o-right font"> Talktime recharge facilities available.</p>
                           <p class="fa fa-caret-square-o-right font"> OTP (One Time Password) for Fund transfer for current session once.</p>
                           <p class="fa fa-caret-square-o-right font"> Email us: headoffice@ebek-rdcd.gov.bd</p>
                           <p class="fa fa-caret-square-o-right font"> Check your Mobile message or e-mail (Inbox/Spam) to get current session OTP (One Time Password).</p>
                        </div>
                     </div>
                      ...
                      <div  class="col-sm-4 wow fadeInDown">
                        <div class="howto-bg rcorners2">
                         <span><img src="pages/images/2.png" style="height:25px;margin-left:10px;margin-top:10px"> </span></br>
                           ...
                           <h3>Need Help</h3>
                            <hr/>
                           <p class="fa fa-caret-square-o-right font"> 24/7 Phone Assistance.</p>
                           <p class="fa fa-caret-square-o-right font"> Please call: 16205, +8801713047887, +8801713388648</p>
                           <p class="fa fa-caret-square-o-right font"> Email us: contact.center@bankasia-bd.com</p>
                           <p class="fa fa-caret-square-o-right font"> URL: bankasia.net</p>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="c-form-1-box wow fadeInRight">
                     <div class="c-form-1-top">
                        <div class="c-form-1-top-left">
                          ...
                          <p><strong><%out.print(session.getAttribute("oIBankingLogInMessageBO"));%></strong></p>
                        </div>
                     ...
                     <div class="c-form-1-bottom">
                        <form role="form" method="post">
                           <div class="form-group">
                              ...
                              <input type="text" name="userID" property="userID" placeholder="User ID..." class="c-form-1-name form-control" id="c-form-1-name" required>
                           </div>
                           <div class="form-group">
                              <label class="sr-only" for="c-form-1-email">Password</label>
                              <input type="text" name="password" property="password" placeholder="Password..." class="c-form-1-email form-control" id="c-form-1-email" required>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" property="" name="chaptcha-code" placeholder="Chaptcha..." class="c-form-1-subject form-control" id="c-form-1-subject" required>
                           </div>
                           <button type="submit" onClick="doSignIn();" class="btn">Login</button>
                        </form>
                     </div>
                  </div>
               </div>
